...
builder.Services.AddOpenTelemetry()
    .WithTracing(tracing => tracing
        .AddSource("CRM.FileStorageService")
...
{
    c.SwaggerDoc("v1", new() { Title = "File Storage Service", Version = "v1" });
...
builder.Services.AddMediatR(cfg =>
    cfg.RegisterServicesFromAssembly(typeof(FileStorageService.Application.ApplicationAssembly).Assembly));

// JWT — consistent logic across all services
