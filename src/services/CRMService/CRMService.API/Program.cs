...
{
    c.SwaggerDoc("v1", new() { Title = "CRM Service", Version = "v1" });
...
builder.Services.AddCloudMessaging(builder.Configuration);

builder.Services.AddInfrastructure(builder.Configuration);

builder.Services.AddMediatR(cfg =>
    cfg.RegisterServicesFromAssembly(typeof(CRMService.Application.ApplicationAssembly).Assembly));

// JWT — verify with the same settings as Identity Service
